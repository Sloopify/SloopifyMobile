...
class GetAllStoryUserPlaces {
  final CreateStoryRepo createStoryRepo;

  GetAllStoryUserPlaces({required this.createStoryRepo});

  Future<Either<Failure, UserPlaceResultEntity>> call({required int page,required int perPage}) async {
    final res = await createStoryRepo.getUserPlaces(page: page,perPage: perPage);
