              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildTextToolbarButton(
                    ...
                    onTap: () => context.read<TextEditingCubit>().toggleCurrentTextBold(),
                  ),
                  Gaps.vGap2,
                  _buildTextToolbarButton(
                    assets: AssetsManager.textItalic,
                    isActive: state.textPropertiesForStory.italic ?? false,
                    onTap: () =>context.read<TextEditingCubit>().toggleCurrentTextItalic(),
                  ),
                  Gaps.vGap2,
                  _buildTextToolbarButton(
                    ...
                    onTap: () =>
                        context.read<TextEditingCubit>().toggleCurrentTextUnderline()
                  ),
                  Gaps.vGap2,
                  InkWell(
                    onTap: () {
                      final nextAlignment = state.textPropertiesForStory.alignment == 'left'
                          ? 'center'
                          : state.textPropertiesForStory.alignment == 'center'
                          ? 'right'
                          : 'left';
                      context.read<TextEditingCubit>().changeCurrentTextAlignmentString(nextAlignment);
                    },
                    child: Icon(_getAlignmentIcon(state.textPropertiesForStory.alignment)),
                  ),
                  Gaps.vGap2,
                  InkWell(
                    onTap: () {
                      ...
                      context.read<TextEditingCubit>().changeCurrentFontType(availableFonts[nextIndex]);
                    },
                      ...
                      [
                        ...
                        Colors.black,
                          ...
                          .map(
                            ...
                            GestureDetector(
                              onTap: () {
                                context.read<TextEditingCubit>().changeCurrentTextColor(color);
                              },
                              child: Container(
                                width: 25,
                                height: 25,
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border: Border.all(
                                    color: state.textPropertiesForStory.color == color
                                        ? Colors.white
                                        : Colors.transparent,
                                    width: 3,
                                  ),
                    ...
                    child: ListView(
                      ...
                      children: availableFonts.map((fontFamily) {
                        return GestureDetector(
                          onTap: () => context.read<TextEditingCubit>().changeCurrentFontType(fontFamily),
                          child: Container(
                            padding: const EdgeInsets.symmetric(
                                horizontal: 12, vertical: 8),
                            margin: const EdgeInsets.symmetric(horizontal: 4),
                            decoration: BoxDecoration(
                              color: state.textPropertiesForStory.fontType == fontFamily
