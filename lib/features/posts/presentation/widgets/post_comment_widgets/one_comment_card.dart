...
class OneCommentCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CommentTreeWidget<Comment, Comment>(
      ...
      contentRoot:
          (context, data) => _buildComment(data, commentEntity: commentEntity),
    );
  }

  Widget _buildComment(Comment data, {required CommentEntity commentEntity}) {
    return Column(
  ...
  Widget _buildReply(Comment data, {required ReplyEntity replyEntity}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        (data.content != null && data.content!.isNotEmpty)
        ...
        Row(
          children: [
            ...
            Gaps.hGap1,
            Text(
              replyEntity.numberOfLike.toString(),
              style: AppTheme.bodyText3.copyWith(fontWeight: FontWeight.w500),
            ),
            Gaps.hGap3,
            Text(
